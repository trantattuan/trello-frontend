...
import { updateCard, deleteCard, getComments, addComment, createChecklist, deleteChecklist, addChecklistItem, updateChecklistItem, uploadAttachment } from '../../api/cards'
        ...
        <div className="bg-white rounded-card shadow-modal w-full max-w-2xl p-6" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button
                      ...
                      className="text-xs text-gray-dark hover:text-red-500 transition-colors"
          ...
          <div className="mb-6 flex flex-wrap gap-2">
            ...
            <button
              ...
              className="text-sm h-9 min-h-0 px-3 rounded-card font-semibold text-red-500 border border-red-200 hover:bg-red-50 transition-colors ml-auto"
            >Delete card</button>
          </div>
